...
public class CommandHandler extends ListenerAdapter {
    ...
    private static final Emoji modding = Emoji.fromUnicode("\u2753");
    ...
    public void onGuildReady(GuildReadyEvent event) {
        ...
        addDescriptions("Explains why hoi4modding.com shouldn't be used");
        addDescriptions("Shows how to add a shine"  + System.lineSeparator() + System.lineSeparator() + getAdmin().getFormatted() +  " **Admin Commands**" + System.lineSeparator());
        ...
        // Modding
        commandDataList.add(Commands.slash("user_directory", descriptionList.get(27)));
        commandDataList.add(Commands.slash("localisation", descriptionList.get(28)));
        commandDataList.add(Commands.slash("debug", descriptionList.get(29)));
        commandDataList.add(Commands.slash("workshop", descriptionList.get(30)));
        commandDataList.add(Commands.slash("crash_data_log", descriptionList.get(31)));
        commandDataList.add(Commands.slash("search_in_files", descriptionList.get(32)));
        commandDataList.add(Commands.slash("crash_mainmenu", descriptionList.get(33)));
        commandDataList.add(Commands.slash("crash_country", descriptionList.get(34)));
        commandDataList.add(Commands.slash("client_ping", descriptionList.get(35)));
        commandDataList.add(Commands.slash("unexpected_token", descriptionList.get(36)));
        commandDataList.add(Commands.slash("nudge_states", descriptionList.get(37)));
        commandDataList.add(Commands.slash("githelp", descriptionList.get(38)));
        commandDataList.add(Commands.slash("mod_error", descriptionList.get(39)));
        commandDataList.add(Commands.slash("date_event", descriptionList.get(40)));
        commandDataList.add(Commands.slash("mapmodding", descriptionList.get(41)));
        commandDataList.add(Commands.slash("hoi4moddingedge", descriptionList.get(42)));
        commandDataList.add(Commands.slash("shine", "Shows how to add a shine"));
    ...
    public static Emoji getModding() { return modding; }
