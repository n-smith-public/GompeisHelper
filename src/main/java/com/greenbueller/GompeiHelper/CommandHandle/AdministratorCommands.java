        ...
        if (event.getName().equals("reload")) {
            if (event.isFromGuild()) {
                if (event.getMember().getId().equals("174645565206953984")) {
                    System.out.println(ConsoleColors.RED + "[ALERT] Command list has been reloaded by " + event.getUser().getName() + ConsoleColors.RESET);
        ...
        if (event.getName().equals("forcereload")) {
            if (event.isFromGuild()) {
                if (event.getMember().getId().equals("174645565206953984")) {
                    ...
                    System.out.println(ConsoleColors.RED + "[ALERT] Command '" + specifiedCommand + "' has been force reloaded by " + event.getUser().getName() + ConsoleColors.RESET);
